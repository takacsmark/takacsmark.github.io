$(function () {
  ...
  if ($("article").length) {
    for (let i = 0; i < promos.length; i++) {
      let promoHTML = '<section class="row inline-sponsored mb-5 mt-5">';
      promoHTML += '<div class="col">';
      promoHTML += '<div class="card border-light bg-light">';
      ...
      promoHTML +=
        '<div class="font-weight-bold">' + promos[i].title + "</div>";
      ...
      $(
        "article p:nth-of-type(" +
          String(Math.floor(($("article p").length / 4) * (i + 1))) +
          ")"
      ).after(promoHTML);
    }
  }
