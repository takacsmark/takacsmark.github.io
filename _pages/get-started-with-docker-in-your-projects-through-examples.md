          ...
          <div class="mt-20">
            ...
            <div class="mt-6 sm:max-w-3xl">
              ...
              <p class="mt-6 text-lg text-lime-500">
                <s>$34.99</s> $15.99 - Download the book 54% OFF.
              </p>
            </div>
            <div class="mt-6">
...
<section class="overflow-hidden bg-white">
  <div class="relative px-4 pt-20 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <div class="relative lg:flex lg:items-center">
      <div class="hidden w-64 h-64 lg:block lg:flex-shrink-0 xl:h-80 xl:w-80">
      </div>

      <div class="relative lg:ml-10">
        <svg class="absolute top-0 left-0 text-indigo-200 opacity-50 transform -translate-x-8 -translate-y-24 h-36 w-36" stroke="currentColor" fill="none" viewBox="0 0 144 144" aria-hidden="true">
        ...
        <blockquote class="relative">
          <div class="text-2xl font-medium text-gray-900 leading-9">
            <p>
                I read many books, and studied online tutorials. None of them helped me as much as your content. You rock!
            </p>
          </div>
          <footer class="mt-8">
            <div class="flex">
              <div class="ml-4 lg:ml-0">
                <div class="text-base font-medium text-gray-900">Ozzy</div>
              </div>
            </div>
          </footer>
        </blockquote>
  ...
  <div class="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:py-24 lg:px-8">
    <div class="max-w-3xl mx-auto text-center">
      <h2 class="text-3xl font-extrabold text-gray-900">Your Docker skills in one book</h2>
      <p class="mt-4 text-lg text-gray-500">A code-along tutorial from zero to job-ready.</p>
    </div>
    <dl class="mt-12 text-left space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">
      <div class="flex">
