...
- Google developed [angular.js](https://angular.io/), which is a web framework to create single page applications. 
...
![Gap Angular example]({{ site.url }}/assets/images/in-content/gap_angular_example.jpg)
