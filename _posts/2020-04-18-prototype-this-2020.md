...
**Another key tool that you can set up on premises is [Gitlab](https://about.gitlab.com/){:target="\_blank"}**. _Gitlab with Jenkins is a frequent combination in enterprise projects._
