...
<section class="row mb-4">
    <div class="col-12 col-sm-4 col-xl-3 mt-2 text-center">
    ...
    <div class="col mt-2 pl-lg-5">
        <h1 class="mb-4  display-4">Build the Docker skills your project needs!</h1>
        <ul>
